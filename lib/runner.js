...
Runner.prototype.run = function() {
  ...
  // Feeder events
  this.bubble("tick", this.feeders, [this.executors, this.analyzers, this.deciders, this]);
  this.bubble("book", this.feeders, [this.executors, this.analyzers, this.deciders]);
...
Runner.prototype.stop = function(err) {
  ...
  if (!err) {
    ...
    this.summarizers.event("summary", summary);
  }
