...
State.prototype.open_position = function(type, amount, price, owner) {
  var self = this;

  var position = new Position(type, owner, this);
  ...
  position.open(amount, price, this.getTime());
...
State.prototype.setTime = function(time) {
  this._time = time;
};
